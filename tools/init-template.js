...
function readmeMarkdown(config, options = {}) {
  ...
  return [
    `# ${project} Pulseboard`,
    "",
    `This repository is the local Pulseboard for ${project}. It keeps project status, task records, durable notes, graph artifacts, and optional daily activity digests in plain files that can be inspected and versioned.`,
    "",
    ...
    "## Project Commands",
    "",
    "Ask a coding agent that follows [AGENTS.md](AGENTS.md) to run project-management commands in natural language:",
    "",
    "```text",
