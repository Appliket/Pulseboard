...
assert.match(markdown, /"knowledge_sources": \[/);
...
assert.match(readme, /Query the wiki/);
assert.match(readme, /Lint the wiki/);
...
assert.match(readme, /\[raw\/meetings\/\]\(raw\/meetings\/\)/);
assert.match(readme, /\[raw\/requests\/\]\(raw\/requests\/\)/);
assert.match(readme, /\[raw\/specs\/\]\(raw\/specs\/\)/);
